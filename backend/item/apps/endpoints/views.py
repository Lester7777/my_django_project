...
from item.wsgi import registry
...
class PredictView(views.APIView):
    def post(self, request, endpoint_name, format=None):
        ...
        label = prediction["destination"] if "destination" in prediction else "error"
...
class StopABTestView(views.APIView):
    def post(self, request, ab_test_id, format=None):
        ...
        try:
            ...
            accuracy_1 = correct_responses_1 / float(all_responses_1) if all_responses_1 > 0 else 0
            ...
            accuracy_2 = correct_responses_2 / float(all_responses_2) if all_responses_2 > 0 else 0
